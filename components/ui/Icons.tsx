...
export const IconHabits = ({ className }: { className?: string }) => (
...
export const IconLearning = ({ className }: { className?: string }) => (
...
export const IconRoutines = ({ className }: { className?: string }) => (
...
export const IconTimeBlocks = ({ className }: { className?: string }) => (
...
export const IconMeals = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15.372 21.686c-1.12.358-2.31.54-3.538.54-1.228 0-2.418-.182-3.538-.54M15.372 21.686c.45-.143.885-.328 1.3-.54M15.372 21.686c1.12.358 2.31.54 3.538.54 1.228 0 2.418-.182 3.538-.54M8.628 21.686c-.45-.143-.885-.328-1.3-.54M8.628 21.686c-1.12.358-2.31.54-3.538.54-1.228 0-2.418-.182-3.538-.54m0 0A2.25 2.25 0 013 19.5V8.25c0-1.242 1.008-2.25 2.25-2.25h13.5A2.25 2.25 0 0121 8.25v11.25c0 .341-.076.666-.214.962m-12.438 0a2.25 2.25 0 01-2.14-2.142v-2.142a2.25 2.25 0 012.14-2.142h2.142a2.25 2.25 0 012.14 2.142v2.142a2.25 2.25 0 01-2.14 2.142h-2.142z" /></svg>
);
...
export const IconHelpCircle = ({ className }: { className?: string }) => (
...
export const IconUsers = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.958 0m0 0a3.75 3.75 0 01-5.958 0M3 18.72a9.094 9.094 0 013.741-.479 3 3 0 014.682-2.72M12 12a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);
...
export const IconCalendarDays = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
