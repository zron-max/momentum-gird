...
function ActivityAnalytics() {
  ...
  const processHabitCompletionData = (
    ...
    return Object.entries(dailyData).map(([date, completions]) => ({
      date,
      completions,
    }))
  }
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {analytics.userActivity.totalHabits}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {analytics.userActivity.totalGoals}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {analytics.userActivity.totalProjects}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Daily habit completions over the last 30 days
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
