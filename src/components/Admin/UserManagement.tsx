...
function UserManagement({ onStatsUpdate }: UserManagementProps) {
  ...
  const approveUser = (u: User) => updateUser(u.id, { status: USER_STATUS.APPROVED });
  const rejectUser = (u: User) => updateUser(u.id, { status: USER_STATUS.REJECTED });
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      setEditingUser({ ...editingUser, is_admin: val === 'admin' })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
